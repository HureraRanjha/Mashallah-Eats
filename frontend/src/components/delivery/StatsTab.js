    ...
    <div className="space-y-6">
      ...
      <div className="stats stats-vertical lg:stats-horizontal shadow w-full">
        ...
        <div className="stat">
          ...
          <div className="stat-value text-primary">{stats.total_deliveries || 0}</div>
          <div className="stat-desc">{stats.active_deliveries || 0} active</div>
        </div>
      </div>
      ...
      {/* Bonus Eligibility */}
      {stats.eligible_for_bonus && (
        <div className="alert alert-success">
          <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <span>You're eligible for a bonus! Keep up the great work.</span>
        </div>
      )}
